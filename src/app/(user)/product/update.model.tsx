                            ...
                            <View key={index} style={{
                                ...
                                <View style={{flex: 1, gap: 10}}>
                                    ...
                                    <View style={{justifyContent:"space-between", flexDirection:'row'}}>
                                        <Text style={{color: "#66cccc", fontWeight: 'bold'}}>{currencyFormatter(item?.price)}</Text>
                                        <View  
                                            style={{
                                                alignItems: "center",
                                                flexDirection: "row",
                                            ...
                                            >
                                                <AntDesign name="minussquareo" size={24} color={'#66cccc'}></AntDesign>
                                            </Pressable>
