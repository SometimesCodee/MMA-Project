...
const CreateModalPage = () => {
    ...
    const hanleAddCart = () => {
        if (restaurant?._id && menuItem) {
            ...
            //check options da them vao chua
            if(cart[restaurant._id].items[item._id]){
        ...
        >
            ...
            >
                                ...
                                <View style={{
                                    ...
                                    <Pressable
                                        ...
                                        style={({ pressed }) => ({
                                            ...
                                            padding: 2,
                                            borderRadius: 2,
                                            backgroundColor: index === selectedIndex ? "#66cccc" : "white",
                                            borderColor: index === selectedIndex ? "#66cccc" : "grey",
                                            borderWidth: 1
                                        })}>
                ...
                <View style={{
                    ...
                    <Pressable onPress={hanleAddCart} style={({ pressed }) => ({
                        opacity: pressed === true ? 0.5 : 1,
                        padding: 10,
