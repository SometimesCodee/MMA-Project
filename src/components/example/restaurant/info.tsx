        ...
        <View style={{
            ...
            <View style={{ height: 60, margin: 10 }}>
                <Text style={{ lineHeight: 30}} numberOfLines={2} ellipsizeMode='tail'>
                    <View>
                        <Text style={{ color: "white", backgroundColor: "#66CCCC", padding: 0, margin: 0 }}>{`  Yêu thích  `}</Text>
                    </View>
                    <Text>{` `}</Text>
                ...
                <View style={{ marginHorizontal: 10, marginVertical: 5, gap: 10 }}>
                    <View style={{ flexDirection: "row", gap: 10, alignItems: "center" }}>
                        <View style={{
                            ...
                            alignItems: "center",
                            backgroundColor: "rgba(247, 227, 54, 0.98)"
                        }}>
                            <AntDesign name="rocket1" size={25} color={"#66CCCC"} />
                        </View>
                        <View>
                    ...
                    <View style={{ gap: 5 }}>
                        <View style={{ flexDirection: "row", gap: 5, alignItems: "center" }}>
                            <AntDesign name="gift" size={12} color={"#66CCCC"} />
