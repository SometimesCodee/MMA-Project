    ...
    const animatedArrowColorStyle = useAnimatedStyle(() => {
        return {
            color: interpolateColor(
                scrollY.value,
                [0, 100],
                ['white', "#66CCCC"], // Arrow color range
            ),
        };
    });
        ...
        <View>
                ...
                renderItem={({ item, index }) => (
                    ...
                    >
                        <View style={{
                            ...
                            borderBottomColor: item.index === activeMenuIndex ? "#66CCCC" : "grey",
                            borderBottomWidth: 2
                        }}>
                            <Text style={{
                                color: item.index === activeMenuIndex ? "#66CCCC" : "black",
                                marginHorizontal: 5,
                            }}>{item.title}</Text>
                        </View>
                    </TouchableOpacity>
            ...
            <AnimatedSectionList
                ...
                renderItem={({ item, index }: { item: any, index: any }) => {
                    ...
                    return(
                        <View style={{ backgroundColor: "white", gap: 10, flexDirection: "row", padding: 10 }}>
                            <View>
                                <Image
                            ...
                            <View style={{ flex: 1, gap: 10 }}>
                                ...
                                <View style={{justifyContent: 'space-between', flexDirection: 'row'}}>
                                    <View><Text style={{ fontWeight: "bold", color: "#66CCCC" }}>{currencyFormatter(menuItem.basePrice)}</Text></View>
                                    <AntDesign name="plussquare" size={24} color="#66CCCC"/>
                                </View>
                            </View>
                        </View>
                    )
